...
add_custom_target(clang ALL
	...
	COMMAND ${CMD_SET_PATH} ${LLVM_COMPILER_ARGS} ${CMAKE_COMMAND} ${CMAKE_CURRENT_SOURCE_DIR}/llvm ${LLVM_CONFIG_OPTIONS} "-DLLVM_ENABLE_PROJECTS=clang;lld" "-DCMAKE_INSTALL_PREFIX=${LLVM_INSTALL_PREFIX}" "-DCMAKE_SYSTEM_NAME=${CMAKE_SYSTEM_NAME}"
